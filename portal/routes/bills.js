...
module.exports = function (app, request, ports) {
    app.get('/endpoints/bills/pay', function (req, res) {
        ...
        request.post(options, function (error, response, body) {
            ...
            var options = {
                method: 'POST',
                uri: `${req.protocol}://${process.env.BASE_PATH}:${ports.bills}${process.env.UPSERT_BILL_ENDPOINT}`,
                body: params,
                json: true
            };
            request.post(options, function (error, response, body) {
    ...
    app.post('/endpoints/bills/get', function (req, res) {
        var options = {
            method: 'POST',
            uri: `${req.protocol}://${process.env.BASE_PATH}:${ports.bills}${process.env.GET_BILLS_ENDPOINT}`,
            body: req.body,
            json: true
        };
        request.post(options, function (error, response, body) {

module.exports = function (app, request, ports) {
    app.post('/endpoints/login', function (req, res) {
        var options = {
            method: 'POST',
            uri: `${req.protocol}://${process.env.BASE_PATH}:${ports.authentication}${process.env.LOGIN_ENDPOINT}`,
            body: req.body,
            json: true
        };
    ...
    app.post('/endpoints/signup', function (req, res) {
        ...
        var options = {
            method: 'POST',
            uri: `${req.protocol}://${process.env.BASE_PATH}:${ports.authentication}${process.env.SIGNUP_ENDPOINT}`,
            body: req.body,
            json: true
        };
        request.post(options, function (error, response, body) {
